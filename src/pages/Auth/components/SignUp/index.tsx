    ...
    <div className={styles.root}>
      {
        state.isSuccess ? (
          <div className={styles.form}>
            <Typography variant="h4" component="h2" color="initial">Вы успешно зарегистрированы</Typography>
            <Typography variant="h5" component="h3" color="initial">Пройдите аутентефикацию</Typography>
            <Button
              variant="contained"
