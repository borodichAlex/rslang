...
export const wordConstructorData = {
  ...
  description:
    'В этой игре вам будет дано слово на русском языке, вам необходимо будет собрать перевод этого слова на английском языке из предоставленных английских букв ',
  bg: '#008000',
  amountWords: 50,
};
